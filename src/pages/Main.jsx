                ...
                <div className="row row-cols-1 row-cols-md-3 row-cols-lg-5">
                    {
                        filmsSearced.map((film) => (
                            <div className="col p-3" key={film.id}>
                                <img src={film.poster_path ? `https://image.tmdb.org/t/p/w342/${film.poster_path}` : 'https://image.tmdb.org/t/p/w342/wwemzKWzjKYJFfCeiB57q3r4Bcm.png'} alt={film.original_title} className='img-fluid'/>
                                <div className='d-none'>
                                    <h1><strong>Titolo</strong>:{film.title}</h1>
                                    <h2><strong>Titolo originale</strong>:{film.original_title}</h2>
                    ...
                    }
                    {
                        serieTVSearced.map((serieTv) => (
                            <div className="col p-3" key={serieTv.id}>
                                <img src={serieTv.poster_path ? `https://image.tmdb.org/t/p/w342/${serieTv.poster_path}` : 'https://image.tmdb.org/t/p/w342/4SZQqcsaETKSKo15lYQO8RAcBpv.jpg'} alt={serieTv.original_name} className='img-fluid' />
                                <div className='d-none'>
                                    <h1>{serieTv.name}</h1>
